        ...
        <div className="flex flex-col items-center text-center space-y-4">
          ...
          <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
            {homeSettings?.hero_subtitle ||
              "Developing the next generation of job-ready tech professionals"}
          </p>
        </div>
      </section>
      ...
      <section className="container px-4">
        <div className="mx-auto max-w-[800px] space-y-6">
          ...
          <p className="text-gray-500 md:text-lg/relaxed lg:text-base/relaxed xl:text-lg/relaxed dark:text-gray-400">
            Learnathon, created by Geeky Solutions, is dedicated to developing the
            next generation of job-ready tech professionals. We offer an immersive,
            mentorship-driven experience to equip you with the technical and
            professional skills demanded by today's job market.
          </p>
          <p className="text-gray-500 md:text-lg/relaxed lg:text-base/relaxed xl:text-lg/relaxed dark:text-gray-400">
            Through real-time projects, collaborative work, and expert guidance, we
            aim to help you bridge the gap between academic knowledge and industry
            expectations.
          </p>
        </div>
      </section>
